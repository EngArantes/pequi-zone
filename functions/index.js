...
const {getFirestore, collection, addDoc, query,
  where, getDocs} = require("firebase-admin/firestore");
...
exports.createStation = onRequest(async (req, res) => {
  cors(req, res, async () => {
    if (req.method !== "POST") {
...
exports.uploadStream = onRequest({timeoutSeconds: 540, cors: true},
    async (req, res) => {
      cors(req, res, async () => {
